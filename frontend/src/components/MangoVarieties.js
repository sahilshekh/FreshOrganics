...
const MangoVarieties = () => {
  ...
  const varieties = [
    ...
    { name: 'Devgad Alphonso', description: 'Premium variety with thicker pulp and intense sweetness, often export quality.', price: 899, originalPrice: 3500, isBestSeller: false, image: 'https://encrypted-tbn0.gstatic.com/images?q9GcT2mhljZJr72WypkJoGFAQtd-2swYg_7JdxalENCR-QXQDVZsZQjddU9lQ8Hhsd3j4hv0I&usqp=CAU' },
    { name: 'Ratnagiri Alphonso', description: 'Celebrated for its delicate skin, fragrant aroma, and balanced sweetness.', price: 599, originalPrice: 3500, isBestSeller: false, image: 'https://encrypted-tbn0.gstatic.com/images?q9GcQigQ7tqv15Ch972iKoYJlQk1OPG6baoMvqkQ&s' },
