  ...
  return (
    <div className="bg-gray-50 min-h-screen font-sans text-gray-800">
      ...
      <section className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto py-12 sm:py-16 text-center">
          {/* Desktop Hero */}
          ...
          <div className="md:hidden relative">
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-6 bg-gradient-to-t from-green-900/80 via-green-900/60 to-transparent">
              <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">
                Welcome to <span className="text-yellow-500">OnlyFams</span> where your daily dose
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center gap-8 lg:gap-12">
            <div className="md:w-1/2">
              <h2 className="text-3xl lg:text-4xl font-semibold text-green-700 mb-4">
                100% Green
              </h2>
      ...
      <section className="hidden md:block bg-green-50 py-12 sm:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl lg:text-4xl font-semibold text-gray-800 text-center mb-8 text-green-700">
            Our Values
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 lg:gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <Leaf className="h-12 w-12 lg:h-14 lg:w-14 text-green-500 mx-auto mb-4" />
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <Sprout className="h-12 w-12 lg:h-14 lg:w-14 text-green-500 mx-auto mb-4" />
              <h3 className="text-xl lg:text-2xl font-semibold text-gray-800 mb-2">
                Sustainability
              </h3>
              <p className="text-gray-600 text-sm lg:text-base">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <Users className="h-12 w-12 lg:h-14 lg:w-14 text-green-500 mx-auto mb-4" />
              <h3 className="text-xl lg:text-2xl font-semibold text-gray-800 mb-2">
                Community Focus
              </h3>
              <p className="text-gray-600 text-sm lg:text-base">
      ...
      <section className="md:hidden bg-white py-12">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-4xl sm:text-5xl font-semibold text-green-700 mb-6">
            100% GREEN
          </h2>
      ...
      <section className="md:hidden bg-gray-100 py-12">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl sm:text-4xl font-semibold text-green-700 mb-6">
            Our Goal?
          </h2>
          <p className="text-base sm:text-lg leading-relaxed text-gray-700">
      ...
      <section className="md:hidden bg-white py-12">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl sm:text-4xl font-semibold text-green-700 mb-8">
            Why You’ll Love Us
          </h2>
          <div className="space-y-8">
            <div className="flex flex-col items-center">
              <Sprout className="h-8 w-8 sm:h-10 sm:w-10 text-green-600 mb-4" />
              <div>
                <h3 className="text-lg sm:text-xl font-medium text-gray-800">
                  Fresh Daily Deliveries
                </h3>
                <p className="text-sm sm:text-base text-gray-600">
                  Daily deliveries of seriously fresh produce.
                </p>
              </div>
            </div>
            <div className="flex flex-col items-center">
              <Users className="h-8 w-8 sm:h-10 sm:w-10 text-green-600 mb-4" />
              <div>
                <h3 className="text-lg sm:text-xl font-medium text-gray-800">
            ...
            <div className="flex flex-col items-center">
              <Leaf className="h-8 w-8 sm:h-10 sm:w-10 text-green-600 mb-4" />
              <div>
                <h3 className="text-lg sm:text-xl font-medium text-gray-800">
      ...
      <section className="bg-green-700 py-12 sm:py-16 text-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-semibold mb-4">
            Join the onlyfams Community
          </h2>
          <p className="text-base sm:text-lg lg:text-xl mb-6">
            Experience the difference of fresh, organic produce at your doorstep.
          </p>
          <Link
            to="/subscriptions"
